...
export const getServerSideProps: GetServerSideProps = async (ctx) => {
  ...
  const stats = { claps: user.claps.length, bookmarks: user.bookmarks.length };

  return {
    props: {
      author: { name: user.name, image: user.image, role: user.role },
      stats,
      goals: JSON.parse(JSON.stringify(user.readingGoals)),
      achievements: JSON.parse(JSON.stringify(user.achievements)),
