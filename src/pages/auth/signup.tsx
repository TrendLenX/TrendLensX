...
export default function SignUp({ hasGoogle }: SignUpProps) {
  ...
  return (
    <>
      <SEOHead title="Create Account" description="Create your free TrendLensX account" />
        ...
        <div className="max-w-md w-full space-y-8 bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Join thousands of readers and creators on TrendLensX
            </p>
          </div>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <input
                ...
                minLength={2}
                autoComplete="name"
                className="appearance-none block w-full px-4 py-3 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent sm:text-sm"
